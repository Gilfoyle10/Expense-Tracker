        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 bg-[#121212]">
          {isLoading ? (
            <div className="space-y-6">
              <div className="h-16 rounded-xl bg-[#1E1E24] animate-pulse" />
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="h-28 rounded-xl bg-[#1E1E24] animate-pulse" />
                ))}
              </div>
              <div className="h-64 rounded-xl bg-[#1E1E24] animate-pulse" />
            </div>
          ) : (
            <DashboardWidgets
              stats={stats}
