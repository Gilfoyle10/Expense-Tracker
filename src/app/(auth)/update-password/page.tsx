    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#121212] text-[#F5F5F5] font-sans">
      <div className="w-full max-w-md space-y-5">
        <div className="text-center space-y-1.5">
          ...
          <h1 className="text-2xl font-black text-[#F5F5F5] tracking-tight">Set New Password</h1>
          <p className="text-xs text-[#9A9AA2] font-medium">Enter a new secure password for your account</p>
        </div>
