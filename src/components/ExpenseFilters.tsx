    ...
    <div className="app-card p-4 space-y-4 mb-5">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 border-b border-slate-100 pb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-1 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-slate-100 text-slate-700 border border-slate-200">
        ...
        <div className="flex flex-wrap items-center gap-1.5 text-xs font-semibold">
            ...
            <button
              ...
              className={`px-3 py-1 rounded-xl text-xs font-bold transition-all ${
                filter.quickRange === preset.id
                  ...
                  : 'bg-slate-100 text-slate-600 hover:bg-slate-200/60 hover:text-slate-900 border border-slate-200/60'
              }`}
            >
              {preset.label}
            </button>
          ...
          {hasActiveFilters && (
            <button
              onClick={onReset}
              className="flex items-center gap-1 px-2.5 py-1 rounded-xl text-xs font-semibold bg-rose-50 text-rose-700 border border-rose-200 hover:bg-rose-100 transition-colors ml-1"
            >
              <RefreshCw size={12} />
              <span>Reset</span>
            </button>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1 rounded-xl text-xs font-extrabold bg-emerald-50 text-emerald-800 border border-emerald-200 hover:bg-emerald-100 transition-colors ml-2 shadow-2xs"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 rounded-xl light-input text-xs text-slate-900 placeholder-slate-400"
            />
            {filter.search && (
              <button
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-1.5 rounded-xl light-input text-xs font-medium text-slate-800"
          >
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-full px-2 py-1.5 rounded-xl light-input text-xs font-medium text-slate-800"
            />
