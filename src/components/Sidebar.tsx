...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      <aside className="w-64 shrink-0 bg-[#F7F8F7] border-r border-[#E6E8E6] flex flex-col justify-between h-full p-4 select-none">
        <div className="space-y-5 overflow-y-auto">
          ...
          <div className="relative px-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 rounded-xl bg-white border border-[#E2E4E2] text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-slate-400 shadow-2xs transition-all"
            />
          </div>

          {/* Navigation Section */}
          <div className="space-y-1">
            <span className="block px-2 text-[10px] font-extrabold uppercase tracking-wider text-slate-400 mb-1">
              Menu
            </span>
            {navItems.map((item) => {
          ...
          {/* Categories Section + Plus Icon & Delete Trash Icon */}
          <div className="space-y-1 pt-2 border-t border-[#E6E8E6]/60">
            <div className="flex items-center justify-between px-2 mb-1">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="p-1 rounded-lg bg-slate-200/60 hover:bg-slate-200 text-slate-700 transition-colors"
                ...
                <button
                  ...
                  className="p-1 rounded-lg bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/50 transition-colors"
        ...
        {/* User Footer */}
        <div className="pt-3 border-t border-[#E6E8E6] space-y-2">
          {!configured && (
            <div className="p-2 rounded-xl bg-amber-50 border border-amber-200 text-[10px] text-amber-800 font-medium flex items-center gap-1.5">
