...
-- 4. Create RLS Policies scoped to auth.uid()
...
COMMENT ON COLUMN public.expenses.category IS 'Category tag (Food, Transport, Housing, Utilities, Entertainment, Health, Other)';
